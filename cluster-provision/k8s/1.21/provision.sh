...
export KUBELET_FEATURE_GATES="VolumeSnapshotDataSource=true,IPv6DualStack=false"
...
KUBELET_EXTRA_ARGS=--cgroup-driver=systemd --runtime-cgroups=/systemd/system.slice --kubelet-cgroups=/systemd/system.slice --feature-gates="VolumeSnapshotDataSource=true,IPv6DualStack=false"
EOT
